                    ...
                    <div class="table">
                        <div class="container">
                            ...
                            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                                ...
                                <el-table-column prop="addressId" label="地址ID" sortable ></el-table-column>
                                <el-table-column prop="userId" label="用户ID"  ></el-table-column>
                                <el-table-column prop="consigneeName" label="收货人姓名" ></el-table-column>
                                <el-table-column prop="mobile" label="手机号码"  ></el-table-column>
                                <el-table-column prop="address" label="收货地址"  ></el-table-column>
                                <el-table-column prop="isDefault" label="是否为默认地址" :formatter="statusFormat"></el-table-column>
